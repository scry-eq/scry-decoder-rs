//! Rust mirrors of EQ wire structs, generated by `tools/gen_eqstructs.py`
//! against `showeq-daemon/src/backend/live/everquest.h`. To add a struct:
//! append it to `ALLOWLIST` in the script, re-run, and commit the regenerated
//! `bindings.rs`.
//!
