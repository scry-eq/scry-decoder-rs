...
fn malformed_fixture() -> (u16, ffi::SessionDirection) {
    ...
    #[cfg(feature = "backend-eql")]
    return (0x5bfb, ffi::SessionDirection::ServerToClient);
}
...
fn stateful_bridge_sessions_are_isolated_when_interleaved() {
    ...
    first_payload[22..26].copy_from_slice(&101.0f32.to_le_bytes());
    ...
    second_payload[22..26].copy_from_slice(&202.0f32.to_le_bytes());
